...
module.exports.milestones = [
  ...
  {tick: 4200, check: {structures: 5}, required: true},
  ...
  {tick: 30400, check: {structures: 13}, required: true},
  {tick: 30500, check: {structures: 14}, required: true},
  {tick: 30800, check: {structures: 15}, required: true},
  {tick: 31000, check: {structures: 16}, required: true},
  {tick: 31400, check: {structures: 17}, required: true},
  {tick: 31600, check: {structures: 18}, required: true},
  {tick: 32000, check: {structures: 19}, required: true},
  {tick: 32500, check: {structures: 20}, required: true},
  {tick: 33000, check: {structures: 21}, required: true},
  {tick: 37000, check: {structures: 22}, required: true},
  {tick: 49000, check: {structures: 23}, required: true},
